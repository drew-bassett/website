...
@section ('content')
    ...
    <a href="https://www.credly.com/badges/99749170-3cdd-4b4c-93bd-7af85fd521d6/public_url" target="_blank"><img src="{{ url('images/comptia-a-ce-certification') }}" alt="A+"></a>
    ...
    <a href="https://www.credly.com/badges/15a6a67e-f6ed-497a-8f6a-9b2dc799f522/public_url" target="_blank"><img src="{{ url('images/itil-4-foundation-cpd') }}" alt="ITIL 4 Foundation"></a>
    <a href="https://www.credly.com/badges/48b552ac-2833-4210-8eb3-f0e318729fe4/public_urll" target="_blank"><img src="{{ url('images/google-it-support-certificate') }}" alt="Google IT Support"></a>
