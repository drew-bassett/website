<?php include('header.php'); ?>
    ...
    <p>
        <img src="research.jpg" alt="Drew at the 2015 Research Event" height="25%" width="25%">
   </p>
    <p>
